...
public class CustomBlackButton extends GuiButton
{
    protected static final ResourceLocation buttonTextures = new ResourceLocation(AltisCraft.MODID, "textures/gui/Widgets 2.png");

    public CustomBlackButton(int id, int xPosition, int yPosition, String name, int x, int y)
    {
