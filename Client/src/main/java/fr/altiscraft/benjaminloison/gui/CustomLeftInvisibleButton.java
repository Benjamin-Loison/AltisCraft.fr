...
public class CustomLeftInvisibleButton extends GuiButton
{
    protected static final ResourceLocation buttonTextures = new ResourceLocation(AltisCraft.MODID, "textures/gui/Widgets 1.png");

    public CustomLeftInvisibleButton(int id, int xPosition, int yPosition, String name, int x, int y)
    {
    ...
    public void drawButton(Minecraft mc, int x, int y)
    {
        if(visible)
        {
            ...
            if(packedFGColour != 0)
                ...
                l = 16777120;
            drawString(mc.fontRenderer, displayString, xPosition + width / 2 - 60, yPosition + (height - 8) / 2, l);
        }
    }
}