...
public class CustomOrangeButton extends GuiButton
{
    protected static final ResourceLocation buttonTextures = new ResourceLocation(AltisCraft.MODID, "textures/gui/Widgets 0.png");

    public CustomOrangeButton(int id, int xPosition, int yPosition, String name, int x, int y)
    {
