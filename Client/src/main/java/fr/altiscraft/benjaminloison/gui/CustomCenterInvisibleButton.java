...
public class CustomCenterInvisibleButton extends GuiButton
{
    protected static final ResourceLocation buttonTextures = new ResourceLocation(AltisCraft.MODID, "textures/gui/Widgets 1.png");

    public CustomCenterInvisibleButton(int id, int xPosition, int yPosition, String name, int x, int y)
    {
